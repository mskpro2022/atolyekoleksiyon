...
// zorla=true: güvenlik eşiğini bilerek atla (kullanıcı manuel geri yükleme sırasında onay verdiğinde)
export async function tabloModelleriSenkron(onek, modeller, zorla = false) {
  try {
    ...
    if (!zorla && mevcutSayi > 50 && modeller.length < mevcutSayi * 0.85) {
      ...
      return { yazilan: 0, silinen: 0, iptal: true, mevcutSayi }
    }
