...
const TEMALAR = {
  ...
  beyaz:     { id:"beyaz",     l:"◆ Beyaz",          ac:"Apple tarzı, minimal açık",  bg:"linear-gradient(165deg,#f5f5f7,#f0f0f2,#eeeef0)", bg2:"#f5f5f7", gold:"#1d1d1f", text:"#1d1d1f", sub:"#86868b", dim:"#aeaeb2", card:"rgba(0,0,0,0.035)", border:"rgba(0,0,0,0.1)", header:"rgba(0,0,0,0.035)", headerBorder:"rgba(0,0,0,0.08)", btnBg:"rgba(0,0,0,0.06)", btnBorder:"rgba(0,0,0,0.15)", accent:"#0066cc", danger:"#ff3b30", success:"#34c759", info:"#007aff" },
